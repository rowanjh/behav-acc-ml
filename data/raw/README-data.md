Two zip files, `raw-data-db.zip`, and `raw-data-other.zip` contain data for the study `anonymized`. 
Data files are available at `final_url`. Scripts to accompany the analysis are availabe at `edmond_url` and `github_url`
...
### ruff_behaviour_tidy_2022-11-16.csv
